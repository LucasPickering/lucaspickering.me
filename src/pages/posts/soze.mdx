...
export const metadata = {
  ...
  date: "2020-11-29",
  summary:
    "Hardware mods for my PC, with a suite of software services to make it all run smoothly. The mods include an LCD mounted on the front and a strip of RGB LEDs inside, all driven by a Raspberry Pi Zero.",
  banner: "lucaspickering.me/soze/banner_tnchrw",
  links: {
    Code: "https://github.com/LucasPickering/soze",
  },
  tags: ["post", "project", "python", "typescript", "hardware"],
};
...
<Gallery
  images="lucaspickering.me/soze/pc_pk5qvp"
  caption="The computer, in all its glory"
/>
...
<Gallery
  images="lucaspickering.me/soze/rpi_cmehub"
  caption="The Motor HAT on top with the Raspberry Pi visible underneath it"
/>
...
<Gallery
  images="lucaspickering.me/soze/usb_tpx2md"
  caption="The USB cable where it connects to the PC motherboard"
/>
...
<Gallery
  images="lucaspickering.me/soze/leds_lfwfzh"
  caption="The LED strip routed around the top of the PC"
/>
...
<Gallery
  images="lucaspickering.me/soze/lcd_front_ukcz1w"
  caption="The front of the LCD"
/>
...
<Gallery
  images="lucaspickering.me/soze/lcd_back_qshz9e"
  caption="The back side of the LCD (the larger green board) with the backpack (the smaller blue board)"
/>
...
<Gallery
  images="lucaspickering.me/soze/diagram_z3qw1o"
  caption="A diagram of the software components"
/>
...
<Gallery images="lucaspickering.me/soze/ui_gdzljk" caption="The Söze web UI" />
