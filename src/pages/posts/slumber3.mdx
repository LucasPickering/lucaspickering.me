...
I've spent well over a year now developing Slumber, and while it's more than capable as a daily driver, it still has sharp edges and lacks a lot of features I'd like to implement. Rather than chase feature after feature, my hope is that by offloading a lot of the work onto other tools, Slumber can access far more features than I would ever be able to implement myself.
